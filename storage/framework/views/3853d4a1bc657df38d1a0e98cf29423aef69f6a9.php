                    ...
                    <li class="dropdown user-dropdown">
                        <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">
                            <div class="user-toggle ">
                                <div class="user-avatar sm <?php echo e(getRandomColorClass()); ?> auth-avatar">
                                    <span <?php echo empty(auth()->user()->avatar) ? '' : 'style="display: none;"'; ?>><?php echo e(getUserInitials(auth()->user()->name)); ?></span>
                                    <img src="<?php echo e(!empty(auth()->user()->avatar) ? pathToUrl(auth()->user()->avatar) : '/'); ?>" alt="Avatar" <?php echo !empty(auth()->user()->avatar) ? '' : 'style="display: none;"'; ?>>
                                </div>
                                <div class="user-info d-none d-md-block">
                                    <div class="user-name dropdown-indicator auth-name"><?php echo e(auth()->user()->name); ?></div>
                                    <div class="user-status pb-0"><?php echo e(prettifyRole(auth()->user()->roles()->pluck('name')->toArray()[0])); ?></div>
                                </div>
                            </div>
                        </a>
...
<!-- main header @e  --><?php /**PATH C:\xampp\htdocs\NorthBankApp\resources\views/layouts/includes/header.blade.php ENDPATH**/ ?>