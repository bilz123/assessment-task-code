    ...
    <div class="nk-block-between">
        ...
        <div class="nk-block-head-content">
            <div class="toggle-wrap nk-block-tools-toggle">
                    <a href="<?php echo e(route('events.create')); ?>" class="btn btn-primary" ajax-modal>
...
<script>
 ...
 var table = $('#events-dt').DataTable({
      ...
      autoWidth: true,
      ordering: false,
      ajax: "<?php echo e(route('events-dt')); ?>",
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\NorthBankApp\resources\views/admindashboard/events/index.blade.php ENDPATH**/ ?>